...
If you wish to train locally, follow the steps on how to install Unity ML-Agents in your machine on this page.
[Installing Unity MLAgents](docs/Install_Unity_MLAgents_Local)

The next section is a guide on how to train the AI Agent. This applies for both training environment running in
