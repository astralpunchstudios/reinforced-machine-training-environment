...
The trained AI Agent models are used to customize the weapon's behavior in the game.
...
|-----------------------------------------------------------------------|----------------|-----------|----------------------------------------------------------------------|-----------|
| <img src="images/weapons/Weapon01_EnergyGun.png" width="200px"/>      | EnergyGun      | 0         | [Energy Gun Training Document](docs/Weapon01_EnergyGun.md)           | Complete  |
| <img src="images/weapons/Weapon02_RocketLauncher.png" width="200px"/> | RocketLauncher | 1         | [Rocket Launcher Training Document](docs/Weapon02_RocketLauncher.md) | TBD       |
| <img src="images/weapons/Weapon03_LaserGun.png" width="200px"/>       | LaserGun       | 2         | [Laser Gun Training Document](docs/Weapon03_LaserGun.md)             | TBD       |
| <img src="images/weapons/Weapon04_PortalGun.png" width="200px"/>      | PortalGun      | 3         | [Portal Gun Training Document](docs/Weapon04_PortalGun.md)           | TBD       |
| <img src="images/weapons/Weapon05_RailGun.png" width="200px"/>        | RailGun        | 4         | [Rail Gun Training Document](docs/Weapon05_RailGun.md)               | TBD       |
| <img src="images/weapons/Weapon06_AcidGun.png" width="200px"/>        | AcidGun        | 5         | [Acid Gun Training Document](docs/Weapon06_AcidGun.md)               | TBD       |
| <img src="images/weapons/Weapon07_SniperRifle.png" width="200px"/>    | SniperRifle    | 6         | [SniperRifle Training Document](docs/Weapon07_SniperRifle.md)        | TBD       |
| <img src="images/weapons/Weapon08_AssaultRifle.png" width="200px"/>   | AssaultRifle   | 7         | [AssaultRifle Training Document](docs/Weapon08_AssaultRifle.md)      | TBD       |
| <img src="images/weapons/Weapon09_ElectricGun.png" width="200px"/>    | ElectricGun    | 8         | [Electric Gun Training Document](docs/Weapon09_ElectricGun.md)       | TBD       |
| <img src="images/weapons/Weapon10_MachineGun.png" width="200px"/>     | MachineGun     | 9         | [Machine Gun Training Document](docs/Weapon10_MachineGun.md)         | TBD       |
| <img src="images/weapons/Weapon11_ShotGun.png" width="200px"/>        | ShotGun        | 10        | [Shot Gun Training Document](docs/Weapon11_ShotGun.md)               | TBD       |
